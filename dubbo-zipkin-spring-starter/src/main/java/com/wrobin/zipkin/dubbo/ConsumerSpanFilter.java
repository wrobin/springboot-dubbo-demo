package com.wrobin.zipkin.dubbo;
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        try {
            ...
            if (isTraceDubbo) {
                ...
                String[] spanNameArr = com.alibaba.dubbo.common.utils.StringUtils.split(invoker.getUrl().getParameter("interface"),'.');
                if(spanNameArr != null && spanNameArr.length >0) {
                    spanName = spanNameArr[spanNameArr.length -1] + ":" + invocation.getMethodName();
                }
